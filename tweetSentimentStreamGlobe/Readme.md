...
Στη συνέχεια κάντε pull request του branch σας.
...
* Το τμήμα του κώδικα που ορίζει τη διαβάθμιση των συναισθημάτων και τα χρώματα των ακτίνων που δηλώσατε στο **Παραδοτέο 1**.
Στη συνέχεια κάντε pull request του branch σας.
...
Μεταφέρετε την τελική αναφορά της εργασίας σας εντός του φακέλου σας.
Στη συνέχεια κάντε pull request του branch σας.
