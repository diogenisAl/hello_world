...
## Παραδοτέα
Στο κλαδί (branch) που έχετε δημιουργήσει στο αποθετήριο (repository) του μαθήματος, εντός του φακέλου σας (π.χ.**Ρ2016000**") και συγκεκριμένα στο αρχείο **Readme.md**, καταχωρίστε τα εξής:
...
### Μετά από τη ολοκλήρωση του κάθε παραδοτέου, φροντίστε να κάνετε **pull request** προκειμένου οι αλλαγές σας να εγκριθούν και να ενσωματωθούν στο master branch (υπό την προϋπόθεση ότι δεν θα προκύψει κάποιο conflict).
