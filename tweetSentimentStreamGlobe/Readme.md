...
- [ ] Για κάθε παραδοτέο, θα πρέπει να έχετε δημιουργήσει ένα νέο κλαδί (**branch**) και στη συνέχεια, αφότου έχετε ετοιμάσει το παραδοτέο, να κάνετε ένα αίτημα ενσωμάτωσης (**pull request**) στο αποθετήριο του μαθήματος από όπου το αντιγράψατε. Το αίτημα ενσωμάτωσης θα συνοδεύεται από περιγραφικό τίτλο και σχόλιο. Στο κάθε **σχόλιο** θα πρέπει να αναφέρεται τουλάχιστον ο **Α.Μ.** σας, το **ονοματεπώνυμο** και τα αρχικά του **μαθήματος** (CSCW ή SW) με λατινικούς χαρακτήρες.
